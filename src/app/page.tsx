          ...
          <div className="grid lg:grid-cols-[1fr_1fr] gap-10 lg:gap-16 items-center">
            ...
            <div className="order-2 lg:order-1 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center lg:items-start gap-4">
                {cta}
                <a
                  href="https://github.com/skgandikota/ebills"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Button size="lg" variant="outline" className="text-lg px-6 h-14 gap-2">
                    <Star className="h-5 w-5" /> Star on GitHub
                  </Button>
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-sm text-muted-foreground">
                ...
                <li className="pt-2 border-t">
                  <a href="mailto:info@ebills.co.in" className="hover:text-foreground">info@ebills.co.in</a>
                </li>
                <li>
                  <a href="mailto:support@ebills.co.in" className="hover:text-foreground">support@ebills.co.in</a>
                </li>
              </ul>
            </div>
          </div>
